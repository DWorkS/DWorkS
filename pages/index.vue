<template>
  <div v-if="page">
    <CoreLandingHero :title="page.hero.title" :description="page.hero.description" :links="page.hero.links"
      class="py-10 sm:py-10 md:py-10" :ui="{ title: 'text-4xl sm:text-5xl' }">
      <div
        class="absolute inset-0 landing-grid z-[-1] [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]" />
    </CoreLandingHero>

    <CoreLandingSection class="py-10 sm:py-10 md:pby-10" :ui="{ container: 'gap-10 sm:gap-y-10 flex flex-col' }">
