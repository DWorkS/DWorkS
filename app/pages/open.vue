  ...
  <PageWrapper :loading="!contentData">
    <PageContainer v-if="contentData" :disclaimer="false">
      <UContainer>
        ...
        <UPageCard>
          <span>
            <ULink :title="$t('site.title')" to="/"><b>{{ $t('site.title') }}</b></ULink>
            is a <ULink rel="noopener nofollow" target="_blank" title="Micro Startup"
              href="https://twitter.com/levelsio/status/1194192590309953537"><b>Micro Startup™</b></ULink> which means
            its
